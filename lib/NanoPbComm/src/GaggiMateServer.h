...
class GaggiMateServer {
  ...
  private:
    ...
    // SystemInfo announce timing (rationale in GaggiMateServer.cpp onConnection):
    ...
    volatile bool _configReceived = false; // set when PidSettings arrive; ends the re-announce loop
